...
class AutoEscolaFrancaQuartaFotoActivity :  AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.auto_escola_franca_quarta_foto)

        val imageViewEpg1 = findViewById<View>(R.id.franca_quarta_foto)
