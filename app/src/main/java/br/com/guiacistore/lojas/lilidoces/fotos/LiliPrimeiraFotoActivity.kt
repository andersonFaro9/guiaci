...
import kotlinx.android.synthetic.main.lili_primeira_foto.*
import uk.co.senab.photoview.PhotoViewAttacher

class LiliPrimeiraFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lili_primeira_foto)
