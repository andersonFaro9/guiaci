...
class AcademiaEvolutionActivity : AppCompatActivity(),  Invisible, IFirebase,ICheckPermission {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = FragmentPagerItemAdapter(
                ...
                .add("HISTÓRIA", AcademiaEvolutionHistoriaFragment::class.java)
                .add("SERVIÇOS", AcademiaEvolutionServicosFragment::class.java)
                .add("PROMOÇÕES", AcademiaEvolutionPromocoesFragment::class.java)
