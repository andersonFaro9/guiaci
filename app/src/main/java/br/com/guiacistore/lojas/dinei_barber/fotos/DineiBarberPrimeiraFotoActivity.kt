...
class DineiBarberPrimeiraFotoActivity :  AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.dinei_primeira_foto)

        val foto = findViewById<View>(R.id.dinei_primeira_foto)
