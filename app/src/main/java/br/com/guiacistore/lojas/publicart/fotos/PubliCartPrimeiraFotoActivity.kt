...
class PubliCartPrimeiraFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.publicart_primeira_foto)

        val imageViewPublicart = findViewById<View>(R.id.publicart_primeira_foto)
