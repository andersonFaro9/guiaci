...
class JsBarbeariaTerceiraFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.jsbarbearia_terceira_foto)

        val imageViewEpg1 = findViewById<View>(R.id.jsbarbearia_terceira_foto)
