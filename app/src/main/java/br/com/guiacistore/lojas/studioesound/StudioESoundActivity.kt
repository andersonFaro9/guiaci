package br.com.guiacistore.lojas.studioesound
...
class StudioESoundActivity : AppCompatActivity(), Invisible, IFirebase, CallNumber {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = FragmentPagerItemAdapter(
                ...
                .add("HISTÓRIA", ESoundHistoriaFragment::class.java)
                .add("SOM", ESoundServicosFragment::class.java)
                .add("PROMOÇÕES", ESoundPromocoesFragment::class.java)
