...
class GregSegundaFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.greg_segunda_foto)

        val imageViewEpg1 = findViewById<View>(R.id.greg_segunda_foto)
