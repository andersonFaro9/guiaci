...
class GregPrimeiraFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.greg_primeira_foto)

        val imageViewEpg1 = findViewById<View>(R.id.greg_primeira_foto)
