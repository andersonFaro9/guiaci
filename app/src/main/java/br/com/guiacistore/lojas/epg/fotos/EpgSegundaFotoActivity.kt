...
import kotlinx.android.synthetic.main.epg_segunda_foto.*
import uk.co.senab.photoview.PhotoViewAttacher


class EpgSegundaFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.epg_segunda_foto)

        val imageViewEpg = findViewById<View>(R.id.epg_segunda_foto)
