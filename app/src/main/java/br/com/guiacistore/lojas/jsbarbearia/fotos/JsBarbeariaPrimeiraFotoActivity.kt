...
class JsBarbeariaPrimeiraFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.jsbarbearia_primeira_foto)

        val imageViewEpg1 = findViewById<View>(R.id.jsbarbearia_primeira_foto)
