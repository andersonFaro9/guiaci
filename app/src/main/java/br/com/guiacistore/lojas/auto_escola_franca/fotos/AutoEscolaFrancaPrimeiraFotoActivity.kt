...
class AutoEscolaFrancaPrimeiraFotoActivity :  AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.auto_escola_franca_primeira_foto)

        val imageViewEpg1 = findViewById<View>(R.id.franca_primeira_foto)
