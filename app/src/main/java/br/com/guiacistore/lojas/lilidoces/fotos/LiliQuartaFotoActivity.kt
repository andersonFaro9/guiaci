...
import kotlinx.android.synthetic.main.lili_quarta_foto.*

import uk.co.senab.photoview.PhotoViewAttacher

class LiliQuartaFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lili_quarta_foto)

        val imageViewEpg1 = findViewById<View>(R.id.lili_quarta_foto)
