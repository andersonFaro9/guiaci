...
class JsBarbeariaQuartaFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.jsbarbearia_quarta_foto)

        val imageViewEpg1 = findViewById<View>(R.id.jsbarbearia_quarta_foto)
