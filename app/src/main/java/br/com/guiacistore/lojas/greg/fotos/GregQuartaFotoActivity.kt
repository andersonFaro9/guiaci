...
class GregQuartaFotoActivity : AppCompatActivity(), IButtonOfCloseActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.greg_quarta_foto)

        val imageViewEpg1 = findViewById<View>(R.id.greg_quarta_foto)
