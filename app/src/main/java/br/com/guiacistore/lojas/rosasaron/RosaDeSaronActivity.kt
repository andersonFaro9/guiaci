package br.com.guiacistore.lojas.rosasaron
...
class RosaDeSaronActivity : AppCompatActivity(), ICheckPermission {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = FragmentPagerItemAdapter(
                ...
                .add("HISTÓRIA", RosaDeSaronHistoriaFragment::class.java)
                .add("CULTOS", RosaDeSaronCultoFragment::class.java)
                .add("ESCOLA BÍBLICA DOMINICAL", RosaDeSaronEscolaBiblicaDominicalFragment::class.java)
