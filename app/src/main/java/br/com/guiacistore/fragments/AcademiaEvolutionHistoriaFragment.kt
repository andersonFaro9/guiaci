...
import kotlinx.android.synthetic.main.speednet_fragment_historia.*



class AcademiaEvolutionHistoriaFragment : Fragment(), IFirebase {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        doDatabaseInstance(1)

        return inflater.inflate(R.layout.academia_evolution_fragment_historia, container, false)
