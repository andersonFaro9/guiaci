...
import kotlinx.android.synthetic.main.repsol_fragment_promocoes.*

class RepSolPromocoesFragment : Fragment(), IFirebase {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        doDatabaseInstance(1)
        return inflater.inflate(R.layout.repsol_fragment_promocoes, container, false)
    }
