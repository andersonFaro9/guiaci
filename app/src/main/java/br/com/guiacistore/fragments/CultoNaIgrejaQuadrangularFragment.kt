...
import kotlinx.android.synthetic.main.fragment_culto_na_igreja_quadrangular.*



class CultoNaIgrejaQuadrangularFragment : Fragment(), IFirebase, IConexaoComAInternet, ITextIsSelectable {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        doDatabaseInstance(1)

        return inflater.inflate(R.layout.fragment_culto_na_igreja_quadrangular, container, false)
    }
