...
class ListaDoTerraNossosOleosAdapter(private val context: Context, private var list: List<ListaModel>
                           ) :
        RecyclerView.Adapter<ListaDoTerraNossosOleosAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, type: Int): ViewHolder {
        ...
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.list_row_nossos_oleos_doterra, parent, false);
