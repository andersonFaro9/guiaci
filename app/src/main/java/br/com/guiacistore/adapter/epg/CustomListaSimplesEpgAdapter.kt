...
class CustomListaSimplesEpgAdapter(var context: Context, var listaCustomizadaModel:ArrayList<ListaCustomizadaModel>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            ...
            view = layout.inflate(R.layout.epg_list, parent, false)
