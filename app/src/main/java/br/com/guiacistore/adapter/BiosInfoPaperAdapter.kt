...
class BiosInfoPaperAdapter(private val context: Context, private var list: List<ListaModel>
                           ) :
        RecyclerView.Adapter<BiosInfoPaperAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, type: Int): ViewHolder {
        ...
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.list_row_fotos_bios_info_paper, parent, false);
